...
class VectorRedaction {
	...
	function __construct($n=null) {
		if (is_resource($n) && get_resource_type($n) === '_p_std__vectorT_Redaction_t') {
			$this->_cPtr=$n;
			return;
		}
		switch (func_num_args()) {
...
class Callback {
	...
	function RemoveTileProc($canvasNumber,$cellNumber,$thumbnailId) {
		Callback_RemoveTileProc($this->_cPtr,$canvasNumber,$cellNumber,$thumbnailId);
	}

	static function StaticRemoveTileProc($customData,$canvasNumber,$cellNumber,$thumbnailId) {
		Callback_StaticRemoveTileProc($customData,$canvasNumber,$cellNumber,$thumbnailId);
	}
...
class GSChangesIterator {
	...
	function __get($var) {
		$func = 'GSChangesIterator_'.$var.'_get';
		if (function_exists($func)) {
			$r = call_user_func($func,$this->_cPtr);
			if (!is_resource($r)) return $r;
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
...
class FDFFieldIterator {
	...
	function __get($var) {
		$func = 'FDFFieldIterator_'.$var.'_get';
		if (function_exists($func)) {
			$r = call_user_func($func,$this->_cPtr);
			if (!is_resource($r)) return $r;
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
...
class WebPageSettings {
	...
	function __get($var) {
		$func = 'WebPageSettings_'.$var.'_get';
		if (function_exists($func)) {
			$r = call_user_func($func,$this->_cPtr);
			if (!is_resource($r)) return $r;
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
...
class OptimizerSettings {
	...
	function __get($var) {
		$func = 'OptimizerSettings_'.$var.'_get';
		if (function_exists($func)) {
			$r = call_user_func($func,$this->_cPtr);
			if (!is_resource($r)) return $r;
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
...
class SDFDoc {
	...
	function InitStdSecurityHandler($password,$password_sz=0) {
		return SDFDoc_InitStdSecurityHandler($this->_cPtr,$password,$password_sz);
	}
...
class SecurityHandler {
	...
	function ChangeUserPassword($password,$pwd_length=null) {
		switch (func_num_args()) {
		case 1: SecurityHandler_ChangeUserPassword($this->_cPtr,$password); break;
		default: SecurityHandler_ChangeUserPassword($this->_cPtr,$password,$pwd_length);
		}
	}
	...
	function ChangeMasterPassword($password,$pwd_length=null) {
		switch (func_num_args()) {
		case 1: SecurityHandler_ChangeMasterPassword($this->_cPtr,$password); break;
		default: SecurityHandler_ChangeMasterPassword($this->_cPtr,$password,$pwd_length);
		}
	}
	...
	function InitPassword($password,$pwd_length=null) {
		switch (func_num_args()) {
		case 1: SecurityHandler_InitPassword($this->_cPtr,$password); break;
		default: SecurityHandler_InitPassword($this->_cPtr,$password,$pwd_length);
		}
	}
...
class Rect extends TRN_rect {
	...
	function Attach($rect) {
		Rect_Attach($this->_cPtr,$rect);
	}

	function Update($rect=null) {
		switch (func_num_args()) {
		case 0: $r=Rect_Update($this->_cPtr); break;
		default: $r=Rect_Update($this->_cPtr,$rect);
		}
		return $r;
	}
...
class Page {
	...
	function FlattenField($filed) {
		Page_FlattenField($this->_cPtr,$filed);
	}
...
class Field {
	...
	function SetValue($value) {
		Field_SetValue($this->_cPtr,$value);
	}
...
class Flattener {
	...
	function SetPathHinting($path_hinting) {
		Flattener_SetPathHinting($this->_cPtr,$path_hinting);
	}
...
class Annot {
	...
	function SetColor($c_,$comp_num=3) {
		Annot_SetColor($this->_cPtr,$c_,$comp_num);
	}
	...
	function SetStructParent($keyval) {
		Annot_SetStructParent($this->_cPtr,$keyval);
	}
	...
	function SetOptionalContent($oc) {
		Annot_SetOptionalContent($this->_cPtr,$oc);
	}
...
class Markup extends Annot {
	...
	function SetPopup($bs) {
		Markup_SetPopup($this->_cPtr,$bs);
	}
	...
	function SetSubject($subj) {
		Markup_SetSubject($this->_cPtr,$subj);
	}
...
class FileAttachment extends Markup {
	...
	function SetIconName($icon) {
		FileAttachment_SetIconName($this->_cPtr,$icon);
	}
...
class QuadPoint extends TRN_quadpoint {
	public $_cPtr=null;

	function __set($var,$value) {
		if ($var === 'thisown') return swig_PDFNetPHP_alter_newobject($this->_cPtr,$value);
		TRN_quadpoint::__set($var,$value);
	}

	function __isset($var) {
		if ($var === 'thisown') return true;
		return TRN_quadpoint::__isset($var);
	}

	function __get($var) {
		if ($var === 'thisown') return swig_PDFNetPHP_get_newobject($this->_cPtr);
		return TRN_quadpoint::__get($var);
	}
...
class Action {
	...
	static function CreateHideField($doc,$list_length,$field_list) {
		$r=Action_CreateHideField($doc,$list_length,$field_list);
		if (is_resource($r)) {
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
			if (!class_exists($c)) {
				return new Action($r);
...
class FDFDoc {
	...
	static function CreateFromXFDF($filepath) {
		$r=FDFDoc_CreateFromXFDF($filepath);
		if (is_resource($r)) {
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
			if (!class_exists($c)) {
				return new FDFDoc($r);
...
class Circle extends Markup {
	...
	function __construct($d_or_ann_or_circle=null) {
		if (is_resource($d_or_ann_or_circle) && get_resource_type($d_or_ann_or_circle) === '_p_pdftron__PDF__Annots__Circle') {
			$this->_cPtr=$d_or_ann_or_circle;
			return;
		}
		switch (func_num_args()) {
		case 0: $this->_cPtr=new_Circle(); break;
		default: $this->_cPtr=new_Circle($d_or_ann_or_circle);
		}
	}
}
...
class LineAnnot extends Markup {
	...
	function SetLeaderLineLength($ll) {
		LineAnnot_SetLeaderLineLength($this->_cPtr,$ll);
	}
	...
	function SetLeaderLineExtensionLength($ll) {
		LineAnnot_SetLeaderLineExtensionLength($this->_cPtr,$ll);
	}
	...
	function SetIntentType($style) {
		LineAnnot_SetIntentType($this->_cPtr,$style);
	}
	...
	function SetLeaderLineOffset($ll) {
		LineAnnot_SetLeaderLineOffset($this->_cPtr,$ll);
	}
...
class FreeText extends Markup {
	...
	function SetQuaddingFormat($app_qform) {
		FreeText_SetQuaddingFormat($this->_cPtr,$app_qform);
	}
	...
	function SetEndingStyle($est) {
		FreeText_SetEndingStyle($this->_cPtr,$est);
	}
...
class RedactionAnnot extends Markup {
	...
	function SetUseRepeat($repeat=false) {
		RedactionAnnot_SetUseRepeat($this->_cPtr,$repeat);
	}
...
class Screen extends Annot {
	...
	function GetTriggerAction() {
		$r=Screen_GetTriggerAction($this->_cPtr);
		if (is_resource($r)) {
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
			if (!class_exists($c)) {
				return new Obj($r);
	...
	function SetTriggerAction($action) {
		Screen_SetTriggerAction($this->_cPtr,$action);
	}

	function GetRotation() {
		return Screen_GetRotation($this->_cPtr);
	}

	function SetRotation($rot) {
		Screen_SetRotation($this->_cPtr,$rot);
	}
	...
	function SetBorderColor($c_,$CompNum) {
		Screen_SetBorderColor($this->_cPtr,$c_,$CompNum);
	}
	...
	function SetBackgroundColor($c_,$CompNum) {
		Screen_SetBackgroundColor($this->_cPtr,$c_,$CompNum);
	}
	...
	function SetStaticCaptionText($ct) {
		Screen_SetStaticCaptionText($this->_cPtr,$ct);
	}
	...
	function SetRolloverCaptionText($ct) {
		Screen_SetRolloverCaptionText($this->_cPtr,$ct);
	}
	...
	function SetMouseDownCaptionText($ct) {
		Screen_SetMouseDownCaptionText($this->_cPtr,$ct);
	}
	...
	function SetStaticIcon($ic) {
		Screen_SetStaticIcon($this->_cPtr,$ic);
	}
	...
	function SetRolloverIcon($ic) {
		Screen_SetRolloverIcon($this->_cPtr,$ic);
	}
	...
	function SetMouseDownIcon($ic) {
		Screen_SetMouseDownIcon($this->_cPtr,$ic);
	}
	...
	function SetScaleCondition($sd) {
		Screen_SetScaleCondition($this->_cPtr,$sd);
	}
...
class Sound extends Markup {
	...
	function SetSoundStream($sound_stream) {
		Sound_SetSoundStream($this->_cPtr,$sound_stream);
	}
...
class Text extends Markup {
	...
	function __construct($d_or_mku_or_text=null) {
		if (is_resource($d_or_mku_or_text) && get_resource_type($d_or_mku_or_text) === '_p_pdftron__PDF__Annots__Text') {
			$this->_cPtr=$d_or_mku_or_text;
			return;
		}
		switch (func_num_args()) {
		case 0: $this->_cPtr=new_Text(); break;
		default: $this->_cPtr=new_Text($d_or_mku_or_text);
		}
	}
}
...
class Widget extends Annot {
	...
	function GetTriggerAction() {
		$r=Widget_GetTriggerAction($this->_cPtr);
		if (is_resource($r)) {
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
			if (!class_exists($c)) {
				return new Obj($r);
	...
	function SetTriggerAction($action) {
		Widget_SetTriggerAction($this->_cPtr,$action);
	}

	function GetRotation() {
		return Widget_GetRotation($this->_cPtr);
	}

	function SetRotation($rot) {
		Widget_SetRotation($this->_cPtr,$rot);
	}
	...
	function SetBorderColor($c_,$CompNum) {
		Widget_SetBorderColor($this->_cPtr,$c_,$CompNum);
	}
	...
	function SetStaticCaptionText($ct) {
		Widget_SetStaticCaptionText($this->_cPtr,$ct);
	}
	...
	function SetRolloverCaptionText($ct) {
		Widget_SetRolloverCaptionText($this->_cPtr,$ct);
	}
	...
	function SetMouseDownCaptionText($ct) {
		Widget_SetMouseDownCaptionText($this->_cPtr,$ct);
	}
	...
	function SetStaticIcon($ic) {
		Widget_SetStaticIcon($this->_cPtr,$ic);
	}
	...
	function SetRolloverIcon($ic) {
		Widget_SetRolloverIcon($this->_cPtr,$ic);
	}
	...
	function SetMouseDownIcon($ic) {
		Widget_SetMouseDownIcon($this->_cPtr,$ic);
	}
...
class PDFACompliance {
	...
	function GetRefObj($id,$obj_idx) {
		return PDFACompliance_GetRefObj($this->_cPtr,$id,$obj_idx);
	}
...
class ContentReplacer {
	...
	function __get($var) {
		$func = 'ContentReplacer_'.$var.'_get';
		if (function_exists($func)) {
			$r = call_user_func($func,$this->_cPtr);
			if (!is_resource($r)) return $r;
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
...
class Font {
	...
	static function CreateCIDTrueTypeFont($doc,$font_path,$embed=true,$subset=true,$encoding=null) {
		switch (func_num_args()) {
		case 2: case 3: case 4: $r=Font_CreateCIDTrueTypeFont($doc,$font_path,$embed,$subset); break;
		default: $r=Font_CreateCIDTrueTypeFont($doc,$font_path,$embed,$subset,$encoding);
		}
		if (is_resource($r)) {
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
			if (!class_exists($c)) {
...
class Image {
	...
	static function CreateImageMask($doc,$image_data,$image_data_size_or_width,$width_or_height,$height_or_encoder_hints=null,$encoder_hints=null) {
		switch (func_num_args()) {
		case 4: $r=Image_CreateImageMask($doc,$image_data,$image_data_size_or_width,$width_or_height); break;
		case 5: $r=Image_CreateImageMask($doc,$image_data,$image_data_size_or_width,$width_or_height,$height_or_encoder_hints); break;
		default: $r=Image_CreateImageMask($doc,$image_data,$image_data_size_or_width,$width_or_height,$height_or_encoder_hints,$encoder_hints);
		}
		if (is_resource($r)) {
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
			if (!class_exists($c)) {
	...
	static function CreateSoftMask($doc,$image_data,$image_data_size_or_width,$width_or_height,$height_or_bpc,$bpc_or_encoder_hints=null,$encoder_hints=null) {
		switch (func_num_args()) {
		case 5: $r=Image_CreateSoftMask($doc,$image_data,$image_data_size_or_width,$width_or_height,$height_or_bpc); break;
		case 6: $r=Image_CreateSoftMask($doc,$image_data,$image_data_size_or_width,$width_or_height,$height_or_bpc,$bpc_or_encoder_hints); break;
		default: $r=Image_CreateSoftMask($doc,$image_data,$image_data_size_or_width,$width_or_height,$height_or_bpc,$bpc_or_encoder_hints,$encoder_hints);
		}
		if (is_resource($r)) {
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
			if (!class_exists($c)) {
	...
	static function Create($doc,$filename_or_image_data,$encoder_hints_or_image_data_size_or_width=null,$width_or_height=null,$height_or_bpc=null,$bpc_or_color_space=null,$color_space_or_encoder_hints_or_input_format=null,$encoder_hints_or_input_format=null) {
		switch (func_num_args()) {
		case 2: $r=Image_Create($doc,$filename_or_image_data); break;
		case 3: $r=Image_Create($doc,$filename_or_image_data,$encoder_hints_or_image_data_size_or_width); break;
		case 4: $r=Image_Create($doc,$filename_or_image_data,$encoder_hints_or_image_data_size_or_width,$width_or_height); break;
		case 5: $r=Image_Create($doc,$filename_or_image_data,$encoder_hints_or_image_data_size_or_width,$width_or_height,$height_or_bpc); break;
		case 6: $r=Image_Create($doc,$filename_or_image_data,$encoder_hints_or_image_data_size_or_width,$width_or_height,$height_or_bpc,$bpc_or_color_space); break;
		case 7: $r=Image_Create($doc,$filename_or_image_data,$encoder_hints_or_image_data_size_or_width,$width_or_height,$height_or_bpc,$bpc_or_color_space,$color_space_or_encoder_hints_or_input_format); break;
		default: $r=Image_Create($doc,$filename_or_image_data,$encoder_hints_or_image_data_size_or_width,$width_or_height,$height_or_bpc,$bpc_or_color_space,$color_space_or_encoder_hints_or_input_format,$encoder_hints_or_input_format);
		}
		if (is_resource($r)) {
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
			if (!class_exists($c)) {
...
class Element {
	...
	function SetTextData($text_data,$text_data_size) {
		Element_SetTextData($this->_cPtr,$text_data,$text_data_size);
	}
...
class ElementBuilder {
	...
	function CreateEllipse($cx,$cy,$rx,$ry) {
		$r=ElementBuilder_CreateEllipse($this->_cPtr,$cx,$cy,$rx,$ry);
		if (is_resource($r)) {
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
			if (!class_exists($c)) {
				return new Element($r);
	...
	function Ellipse($cx,$cy,$rx,$ry) {
		ElementBuilder_Ellipse($this->_cPtr,$cx,$cy,$rx,$ry);
	}
...
class Highlights {
	...
	function __construct($hlts=null) {
		if (is_resource($hlts) && get_resource_type($hlts) === '_p_pdftron__PDF__Highlights') {
			$this->_cPtr=$hlts;
			return;
		}
		switch (func_num_args()) {
		case 0: $this->_cPtr=new_Highlights(); break;
		default: $this->_cPtr=new_Highlights($hlts);
		}
	}
...
class PDFDocViewPrefs {
	...
	function __get($var) {
		$func = 'PDFDocViewPrefs_'.$var.'_get';
		if (function_exists($func)) {
			$r = call_user_func($func,$this->_cPtr);
			if (!is_resource($r)) return $r;
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
...
class PDFDoc {
	...
	function __construct($sdfdoc_or_filepath_or_stream_or_buf=null,$buf_size=null) {
		if (is_resource($sdfdoc_or_filepath_or_stream_or_buf) && get_resource_type($sdfdoc_or_filepath_or_stream_or_buf) === '_p_pdftron__PDF__PDFDoc') {
			$this->_cPtr=$sdfdoc_or_filepath_or_stream_or_buf;
			return;
		}
		switch (func_num_args()) {
		case 0: $this->_cPtr=new_PDFDoc(); break;
		case 1: $this->_cPtr=new_PDFDoc($sdfdoc_or_filepath_or_stream_or_buf); break;
		default: $this->_cPtr=new_PDFDoc($sdfdoc_or_filepath_or_stream_or_buf,$buf_size);
		}
	}
	...
	function InitStdSecurityHandler($password,$password_sz=0) {
		return PDFDoc_InitStdSecurityHandler($this->_cPtr,$password,$password_sz);
	}
	...
	function InsertPages($insertBeforeThisPage,$sourceDoc,$startPage_or_sourcePageSet,$endPage_or_flag,$flag=null) {
		switch (func_num_args()) {
		case 4: PDFDoc_InsertPages($this->_cPtr,$insertBeforeThisPage,$sourceDoc,$startPage_or_sourcePageSet,$endPage_or_flag); break;
		default: PDFDoc_InsertPages($this->_cPtr,$insertBeforeThisPage,$sourceDoc,$startPage_or_sourcePageSet,$endPage_or_flag,$flag);
		}
	}

	function MovePages($moveBeforeThisPage,$sourceDoc,$startPage_or_sourcePageSet,$endPage_or_flag,$flag=null) {
		switch (func_num_args()) {
		case 4: PDFDoc_MovePages($this->_cPtr,$moveBeforeThisPage,$sourceDoc,$startPage_or_sourcePageSet,$endPage_or_flag); break;
		default: PDFDoc_MovePages($this->_cPtr,$moveBeforeThisPage,$sourceDoc,$startPage_or_sourcePageSet,$endPage_or_flag,$flag);
		}
	}
	...
	function FDFExtract($flag=null) {
		switch (func_num_args()) {
		case 0: $r=PDFDoc_FDFExtract($this->_cPtr); break;
		default: $r=PDFDoc_FDFExtract($this->_cPtr,$flag);
		}
		if (is_resource($r)) {
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
			if (!class_exists($c)) {
...
class PDFRasterizer {
	...
	function SetPathHinting($path_hinting) {
		PDFRasterizer_SetPathHinting($this->_cPtr,$path_hinting);
	}
	...
	function SetImageSmoothing($smoothing_enabled=true) {
		PDFRasterizer_SetImageSmoothing($this->_cPtr,$smoothing_enabled);
	}
	...
	function SetGamma($exp) {
		PDFRasterizer_SetGamma($this->_cPtr,$exp);
	}
...
class PDFDraw {
	...
	function SetPathHinting($path_hinting) {
		PDFDraw_SetPathHinting($this->_cPtr,$path_hinting);
	}
	...
	function SetImageSmoothing($smoothing_enabled=true) {
		PDFDraw_SetImageSmoothing($this->_cPtr,$smoothing_enabled);
	}
...
class PDFNet {
	...
	static function ConnectToCloud($api_id,$api_secret,$demo_mode=false) {
		return PDFNet_ConnectToCloud($api_id,$api_secret,$demo_mode);
	}
...
class PDFView {
	...
	function Update($all_or_update_or_annot=null,$page_num=null) {
		switch (func_num_args()) {
		case 0: PDFView_Update($this->_cPtr); break;
		case 1: PDFView_Update($this->_cPtr,$all_or_update_or_annot); break;
		default: PDFView_Update($this->_cPtr,$all_or_update_or_annot,$page_num);
		}
	}
	...
	function SetPathHinting($path_hinting) {
		PDFView_SetPathHinting($this->_cPtr,$path_hinting);
	}
	...
	function GetAnnotationAt($x,$y) {
		$r=PDFView_GetAnnotationAt($this->_cPtr,$x,$y);
		if (is_resource($r)) {
			$c=substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
			if (!class_exists($c)) {
				return new Annot($r);
...
class PDFPrint {
	...
	static function StartPrintJob($in_pdfdoc,$in_printerName,$in_jobName,$in_outputFileName,$in_pagesToPrint=null,$in_printerMode=null,$in_cancel=null) {
		PDFPrint_StartPrintJob($in_pdfdoc,$in_printerName,$in_jobName,$in_outputFileName,$in_pagesToPrint,$in_printerMode,$in_cancel);
	}
...
class Stamper {
	...
	function SetPosition($horizontal_distance,$vertical_distance,$percentage=false) {
		Stamper_SetPosition($this->_cPtr,$horizontal_distance,$vertical_distance,$percentage);
	}
...
class Redactor {
	...
	static function Redact($doc,$red_arr,$app=null,$ext_neg_mode=true,$page_coord_sys=true) {
		switch (func_num_args()) {
