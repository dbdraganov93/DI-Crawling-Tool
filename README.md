...
```
cd existing_repo
git remote add origin https://gitlab.com/devs4350851/dicrawler.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/devs4350851/dicrawler/-/settings/integrations)
