...
class Marktjagd_Database_Entity_AmountBrochures extends Marktjagd_Database_Entity_Abstract {

    protected $_idAmountBrochures;
    protected $_idCompany;
    protected $_amountBrochures;
    ...
    protected $_aColumnMap = array(
        'idAmountBrochures' => 'IdAmountBrochures',
        'idCompany' => 'IdCompany',
        'amountBrochures' => 'AmountBrochures',
        'startDate' => 'StartDate',
        'endDate' => 'EndDate',
    ...
    public function getIdAmountBrochures() {
        return $this->_idAmountBrochures;
    }
    ...
    public function getAmountBrochures() {
        return $this->_amountBrochures;
    }
    ...
    public function setIdAmountBrochures($idAmountBrochures) {
        $this->_idAmountBrochures = $idAmountBrochures;
        return $this;
    }
    ...
    public function setAmountBrochures($amountBrochures) {
        $this->_amountBrochures = $amountBrochures;
        return $this;
    }
     ...
     *
     * @return  Marktjagd_Database_Mapper_AmountBrochures
     */
