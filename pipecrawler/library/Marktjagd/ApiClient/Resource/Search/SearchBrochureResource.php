 ...
 * contains the SearchBrochureResource class.
 *
 * PHP version 5
 *
 * @category    resource
 ...
 * @link        http://www.marktjagd.de
 */
class SearchBrochureResource extends Resource\Resource
{

    /**
     * Load a search brochure resource object.
     *
     * @param array  $params    request parameters
     * @return SearchBrochureResource the resource object or NULL if the request failed
     */
    ...
    {
        $this
            ->hasResource(Resource\ResourceFactory::create('brochures'))
