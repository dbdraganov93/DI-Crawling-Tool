...
/**
 * NewGen Brochure Crawler für Grand optics BG (ID: 80575)
 */
class Crawler_Company_GrandOpticsBg_DiscoverBrochure extends Crawler_Generic_Company
{
    ...
    public function crawl($companyId)
    {
        ...
        $endDate = '24.10.2021';
        $brochureNumber = 'GrandOptics_BG_DiscoverOct_2021';
        $coverPage = 'GrandOptics-First.pdf';
        ...
        $localPath = $sFtp->connect('80575', TRUE);
        ...
        $eBrochure->setTitle('Grand optics - Discover')
