...
/* 
 * Store Crawler für Ochsner Shoes CH (ID: 72222)
 */

class Crawler_Company_OchsnerShoesCh_Store extends Crawler_Generic_Company {

    public function crawl($companyId) {
        $baseUrl = 'https://www.ochsner-shoes.ch/';
