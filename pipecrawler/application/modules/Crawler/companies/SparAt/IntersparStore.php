...
/**
 * Store Crawler für INTERSPAR AT (ID: 73449, STAGE ID: 76769)
 */

class Crawler_Company_SparAt_IntersparStore extends Crawler_Generic_Company
{
    public function crawl($companyId)
    {
        $baseUrl = 'https://www.spar.at';
        $searchUrl = $baseUrl . '/standorte/_jcr_content.stores.v2.html?filter=INTERSPAR';
