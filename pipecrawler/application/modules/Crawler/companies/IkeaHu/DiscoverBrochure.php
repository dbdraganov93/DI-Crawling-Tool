...
/**
 * NewGen Brochure Crawler für IKEA HU (Stage ID: 77987)
 */
class Crawler_Company_IkeaHu_DiscoverBrochure extends Crawler_Generic_Company
{
    ...
    public function crawl($companyId)
    {
        ...
        $endDate = '31.12.2022';
        $brochureNumber = 'IKEA_HU_DiscoverSept_2021';
