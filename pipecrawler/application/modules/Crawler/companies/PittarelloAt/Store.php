...
/* 
 * Store Crawler für Pittarello AT (ID: 72302)
 */

class Crawler_Company_PittarelloAt_Store extends Crawler_Generic_Company {
    ...
    public function crawl($companyId) {
        ...
        $searchUrl = $baseUrl . 'wp-admin/admin-ajax.php?action=store_search&lat='
                ...
                . Marktjagd_Service_Generator_Url::$_PLACEHOLDER_LON . '&max_results=75&radius=50';
        ...
        foreach ($aUrls as $singleUrl) {
            ...
            foreach ($jStores as $singleJStore) {
                if (preg_match('#^Ita#', $singleJStore->country)) {
                    continue;
                }
