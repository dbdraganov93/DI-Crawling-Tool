...
/*
 * Dyn Flyer Crawler für BabyOne (ID: 28698)
 */

class Crawler_Company_BabyOne_DynBrochure extends Crawler_Generic_Company
{
    /**
    ...
    function crawl($companyId)
    {
        ...
        $endDate = '04.07.2021';
        $articleFileName = 'Artikelliste_Discover_Baden_06.21_tmp.xlsx';
        $coverPageFileName = 'baden_planschen-eprospekt_titelbild_a4-dd.pdf';
        ...
        $eBrochure->setTitle('BabyOne: Must Haves für den Sommer!')
            ->setBrochureNumber('Baden und Planschen dynamisch')
            ->setVariety('leaflet')
