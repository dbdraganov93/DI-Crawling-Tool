...
/**
 * Store Crawler für SPAR Express AT (ID: 73022, STAGE ID: 76866)
 */

class Crawler_Company_SparAt_SparExpressStore extends Crawler_Generic_Company
{
    public function crawl($companyId)
    {
        $baseUrl = 'https://www.spar.at';
        $searchUrl = $baseUrl . '/standorte/_jcr_content.stores.v2.html?filter=SPAR_EXPRESS';
