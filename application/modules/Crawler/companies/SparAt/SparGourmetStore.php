...
/**
 * Store Crawler für SPAR Gourmet AT (ID: 73332, STAGE ID: 76356)
 */

class Crawler_Company_SparAt_SparGourmetStore extends Crawler_Generic_Company
{
    public function crawl($companyId)
    {
        $baseUrl = 'https://www.spar.at';
        $searchUrl = $baseUrl . '/standorte/_jcr_content.stores.v2.html?filter=SPAR_GOURMET';
