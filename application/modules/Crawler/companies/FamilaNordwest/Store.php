...
/**
 * Store Crawler für Famila Nordwest (ID: 29025)
 */

class Crawler_Company_FamilaNordwest_Store extends Crawler_Generic_Company
{
    public function crawl($companyId)
    {
        ...
        foreach ($aData as $singleRow) {
            if (!preg_match('#^famila#i', $singleRow['Bezeichnung'])) {
                continue;
            }
