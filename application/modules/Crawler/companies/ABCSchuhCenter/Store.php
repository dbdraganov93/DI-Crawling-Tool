...
/*
 * Store Crawler für ABC Schuh-Center (ID: 29190)
 */

class Crawler_Company_ABCSchuhCenter_Store extends Crawler_Generic_Company
{

    public function crawl($companyId)
    {
        $sCollUp = new Marktjagd_Service_Compare_Collection_Store();
        $jsonPage = 'https://www.abc-schuhcenter.de/wp-json/wpgmza/v1/markers/base64eJyrVkrLzClJLVKyUqqOUcpNLIjPTIlRsopRMo9R0gEJFGeUgsSKgYLRsbVKtQCWfhBT';
