...
/*
 * Store Crawler für denn's Biomarkt (ID: 29068)
 */

class Crawler_Company_DennsBiomarkt_Store extends Crawler_Generic_Company
{
    ...
    public function crawl($companyId)
    {
        ...
        foreach ($json->items as $singleStore) {
            ...
            $eStore->setStreetAndStreetNumber($singleStore->address->street)
                ...
                ->setEmail('info@biomarkt.de')
                ->setBonusCard('Mein denn\'s Kundenkarte');
