<?php
/**
 * Store Crawler für Mömax AT (ID: 72787)
 */

class Crawler_Company_MoemaxAt_Store extends Crawler_Generic_Company
{
    public function crawl($companyId): Crawler_Generic_Response
    {
        $sPage = new Marktjagd_Service_Input_Page();
        $cStores = new Marktjagd_Collection_Api_Store();
        $searchUrl = 'https://www.moemax.at/api/graphql?opname=contentPages';
    ...
    {
        $data = '{"operationName":"contentPages","variables":{"code":"filialen-at","cmsTicketId":null},"query":"query contentPages($code: String!, $cmsTicketId: String) {\n  getContentPage(code: $code, cmsTicketId: $cmsTicketId) {\n    uid\n    code\n    name\n    restType\n    title\n    name\n    seoData {\n      canonicalUrl\n      code\n      description\n      keywords\n      name\n      noFollow\n      noIndex\n      url\n      title\n      seoPath\n      __typename\n    }\n    cmsPageType {\n      code\n      type\n      __typename\n    }\n    breadcrumbs {\n      itemCode\n      name\n      restType\n      seoUrl\n      type\n      __typename\n    }\n    smartedit {\n      pageContract\n      __typename\n    }\n    contentSlots\n    __typename\n  }\n}\n"}';
