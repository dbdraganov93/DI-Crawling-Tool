...
/**
 * Brochure MoebelBorst (ID: 80108)
 */
class Crawler_Company_MoebelBorst_Brochure extends Crawler_Generic_Company
{
    ...
    public function crawl($companyId)
    {
        ...
        //Still connect to Hofmeister ftp folder to download data from it.
