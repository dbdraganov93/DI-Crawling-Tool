 ...
 * contains the PermissionCollectionResource class.
 *
 * PHP version 5
 *
 * @category    resource
...
/**
 * Permission collection resource.
 *
 * @category    resource
 * @package     resource
 * @subpackage  product
 ...
 * @link        http://www.marktjagd.de
 */
class PermissionCollectionResource extends Resource\CollectionResource
{
    ...
    {
        $this->hasAttribute(new Resource\ResourceAttribute('hits'));
    }
