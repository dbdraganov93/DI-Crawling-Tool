 ...
 * contains the SearchOffersResource class.
 *
 * PHP version 5
 *
 * @category    resource
...
/**
 * SearchOffers resource
 *
 * @category    resource
 * @package     resource
 * @subpackage  search
 * @author      Lutz Petzoldt <lutz.petzoldt@martkjagd.de>
 * @license     Martktjagd GmbH
 * @link        http://www.marktjagd.de
 */
class SearchOffersResource extends Resource\Resource
{

    /**
     * Load a search offers resource object.
     *
     * @param array  $params    request parameters
     * @return SearchOffersResource the resource object or NULL if the request failed
     */
    ...
    protected function setResourceDefinition()
    {
        $this
            ...
            ->hasResource(Resource\ResourceFactory::create('brands'))
            ->hasResource(Resource\ResourceFactory::create('hypernyms'));
    }
