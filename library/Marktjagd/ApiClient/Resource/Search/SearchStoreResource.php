 ...
 * contains the SearchStoreResource class.
 *
 * PHP version 5
 *
 * @category    resource
 ...
 * @link        http://www.marktjagd.de
 */
class SearchStoreResource extends Resource\Resource
{

    /**
     * Load a search store resource object.
     *
     * @param array  $params    request parameters
     * @return SearchStoreResource the resource object or NULL if the request failed
     */
    ...
    protected function setResourceDefinition()
    {
        $this
            ...
            ->hasResource(Resource\ResourceFactory::create('city_zipcodes'))
            ->hasResource(Resource\ResourceFactory::create('cities'))
            ->hasResource(Resource\ResourceFactory::create('states'))
            ->hasResource(Resource\ResourceFactory::create('counties'));
    }
