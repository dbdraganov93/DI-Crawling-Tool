 ...
 * contains the BrochureResource class.
 *
 * PHP version 5
 *
 * @category    resource
 ...
 * @link        http://www.marktjagd.de
 */
class BrochureResource extends Resource\Resource
{

    const
        STATUS_IMPORT = 'import',
        
        VARIETY_LEAFLET = 'leaflet',
        VARIETY_ONLINE = 'online',
        VARIETY_COUPON = 'coupon',
        VARIETY_CUSTOMER_MAGAZINE = 'customer_magazine';
    ...
    protected function setResourceDefinition()
    {
        $this
            ...
            ->hasField(new Resource\ResourceFieldInteger('type_id'))
            ->hasField(new Resource\ResourceFieldString('variety'))
            ->hasField(new Resource\ResourceFieldString('gender'))
            ->hasField(new Resource\ResourceFieldString('age_range'))
            ->hasField(new Resource\ResourceFieldBoolean('national'))
            ...
            ->hasField(new Resource\ResourceFieldInteger('import_id'))
            ...
            ->hasField(new Resource\ResourceFieldString('download_url'))
            ->hasField(new Resource\ResourceFieldString('tracking_bug'))
            ...
            ->hasField(new Resource\ResourceFieldString('layout'))

            ->hasResource(Resource\ResourceFactory::create('rating'))
            ->hasResource(Resource\ResourceFactory::create('pages'))
